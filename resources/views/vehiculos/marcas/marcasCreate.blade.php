    ...
    <div class="card text-center">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('marcas.store') }}" enctype="multipart/form-data">
                ...
                <div class="mb-3 row">
                    <label for="name_brand" class="col-sm-2 col-form-label">Nombre de la Marca:</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="name_brand" name="name_brand"
                            value="{{ old('name_brand') }}" required>
                        @error('name_brand')
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-8">
                        <input type="file" class="form-control" id="image" name="imagePath" required
                            accept="image/jpeg, image/png, image/jpg, image/gif"
                            onchange="previewImage(event)">
                        <img id="preview" src="#" alt="Vista previa" class="mt-2" style="max-height: 150px; display: none;">
                        <script>

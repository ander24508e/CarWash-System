...
@section('contenido')
    ...
    @if ($clientes_buscar->count() == 0)
        <div class="alert alert-info mt-3">
            No se encontraron clientes con el término: "{{ request()->searchTerm }}"
        </div>
    @else
            ...
            <div class="card shadow">
                ...
                <div class="card-body p-0">
                    <table id="clientes-table" class="table table-striped table-hover mb-0">
                        ...
                        <tbody>
                            @foreach ($clientes_buscar as $cliente)
                                <tr>
                                    <td>{{ $cliente->id }}</td>
                    ...
                    <div class="d-flex justify-content-center mt-3">
                        {{ $clientes_buscar->links('pagination::bootstrap-4') }}
                    </div>
                </div>
            </div>
            <!-- Botón volver -->

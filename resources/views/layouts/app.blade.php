                        ...
                        <ul class="navbar-nav">
                            <ul class="navbar-nav">
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="/ventas"><i
                                                    class="bi bi-list-check me-2"></i>Ventas</a></li>
                            ...
                            <ul class="navbar-nav">
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="/vehiculos"><i class="bi bi-list-check me-2"></i>
                                                Vehiculos</a></li>
                                        <li><a class="dropdown-item" href="/marcas-vehiculos"><i
                                                    class="bi bi-list-check me-2"></i>Marcas</a></li>

                                        <li><a class="dropdown-item" href="/modelos-vehiculos"><i
                                                    class="bi bi-list-check me-2"></i>Modelos</a></li>
                                    </ul>
                                </li>
                            </ul>

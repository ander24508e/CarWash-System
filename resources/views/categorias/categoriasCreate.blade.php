        ...
        <div class="card text-center">
            ...
            <div class="card-body">
                <form method="post" action="{{ route('categorias.store') }}">
                    ...
                    <div class="mb-3 row">
                        <label for="tipeCategory" class="col-sm-2 col-form-label">Tipo de Categoria:</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="tipeCategory" name="tipeCategory"
                                value="{{ old('tipeCategory', $categorias->tipeCategory ?? '') }}">
                        </div>
                        @error('tipeCategory')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
